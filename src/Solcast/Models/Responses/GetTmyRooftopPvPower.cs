...
public class GetTmyRooftopPvPower
{
    ...
    public string Period { get; set; } 
        ...
        /// </summary>    [JsonProperty("ghi_weight")]
    public double? GhiWeight { get; set; } 
        ...
        /// </summary>    [JsonProperty("dni_weight")]
    public double? DniWeight { get; set; } 


        /// <summary>
        /// The probability percentile for the TMY. Allowed values are p50, p75, p90, p95.
        /// </summary>    [JsonProperty("probability")]
    ...
    public string InstallDate { get; set; } 
        ...
        /// </summary>    [JsonProperty("loss_factor")]
